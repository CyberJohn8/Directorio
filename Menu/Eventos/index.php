...
<?php
    $conexion = new mysqli("sql308.infinityfree.com", "if0_39414119", "U7ML7oxb1B", "if0_39414119_geolocalizador");
...
<div class="evento-page">
    ...
    <div class="main-content">
        <header class="event-header">
            <button class="return-button" onclick="location.href='https://cyberjohn.infinityfreeapp.com/Menu/index.php'"></button>
